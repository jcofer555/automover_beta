...
<?php
    ...
    $notify      = isset($settings['ENABLE_NOTIFICATIONS']) ? yes_no($settings['ENABLE_NOTIFICATIONS']) : '—';
    ...
    $excl        = isset($settings['EXCLUSIONS_ENABLED'])   ? yes_no($settings['EXCLUSIONS_ENABLED'])   : '—';
